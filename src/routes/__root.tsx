...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dra. Manoela Souza — Emagrecimento clínico e saúde metabólica" },
      {
        name: "description",
        content:
          "Acompanhamento médico individualizado para emagrecimento clínico, saúde metabólica e qualidade de vida.",
      },
      { property: "og:title", content: "Dra. Manoela Souza — Emagrecimento clínico e saúde metabólica" },
      {
      ...
      { name: "twitter:title", content: "Dra. Manoela Souza — Emagrecimento clínico e saúde metabólica" },
